...
public class TestFrame2P {
	...
	if ( ! zms.checkPassword( "flof_f", new Password( "falsch" ) ) ) System.out.println( "OK#1" );
	if ( zms.checkPassword( "flof_f", new Password( "xX_15_Xx" ) ) ) System.out.println( "OK#2" );
	try {
	zms.del( "???_?" );
	...
	Admin a = new Admin( "xxx_x", new Password( "xX_##_Xx" ), new Person( "Xxxxx", "Xxx", "EDV" ) );
	tmpu= a;
