...
//import sname_fname.part4.*;


//TestFrame fuer part4
public class TestFrame4 {
    ...
    public static void main( String[] argv ){
        ...
        // part4 bzw. part3 entsprechend modifiziert und ergänzt
        
        System.out.printf( "vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv\n" );
        try {
            zs.del( new RH( new KZ( Ort.W, "MHx03" ), new Halter( "Rabe", "Ronja" )));
            System.out.printf( "true\n" );
        }catch( NonExistingMHException ex ){
        ...
        System.out.printf( "vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv\n" );
        try {
            zs.del( new RH( new KZ( Ort.S, "MHx06" ), new Halter( "Rabe",   "Ronja" )   ) );
            System.out.printf( "true\n" );
        }catch( NonExistingMHException ex ){
            System.out.printf( "false\n" );
        }//try
        try {
            zs.del( new LK( new KZ( Ort.H, "MHx07" ), new Halter( "Oller",  "Otto" ), 2 ) );
            System.out.printf( "true\n" );
        }catch( NonExistingMHException ex ){
            System.out.printf( "false\n" );
        }//try
        try {
            zs.del( new LK( new KZ( Ort.K, "MHx08" ), new Halter( "Lustig", "Lara" ), 2 ) );
            System.out.printf( "true\n" );
        }catch( NonExistingMHException ex ){
            System.out.printf( "false\n" );
        }//try
